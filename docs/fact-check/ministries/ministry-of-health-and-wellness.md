# Fact-check: Ministry of Health and Wellness
...
- **Type:** descriptive
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — verbatim match; [health.gov.bb — Mission/Vision](https://www.health.gov.bb/About/Mission-Vision) — carries a distinct mission statement ("To manage a comprehensive, coordinated and integrated health services programme...") which is the ministry website's own framing, not the gov.bb mandate. The alpha.gov.bb text reproduces the gov.bb mandate exactly.
- **Status:** verified
- **Certainty:** 99%

---

### Claim 2 — Ministry name (line 1; ministries.ts line 508)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Ministry of Health and Wellness</pre>
</div>
...
- **Type:** agency name
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health); [health.gov.bb — Home](https://www.health.gov.bb/)
- **Status:** verified
- **Certainty:** 99%

---

### Claim 3 — PBX telephone (line 7)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">PBX    (246) 536-3800</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — lists PBX 536-3800; [health.gov.bb — Contact Us](https://www.health.gov.bb/Contact) — lists "+1 (246) 536-3800"
- **Status:** verified
- **Certainty:** 99%

---

### Claim 4 — Minister telephone (line 8)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Minister    (246) 536-3801</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — lists Minister 536-3801; [health.gov.bb — Contact Us](https://www.health.gov.bb/Contact) — same
- **Status:** verified
- **Certainty:** 99%

---

### Claim 5 — Permanent Secretary telephone (line 9)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Permanent Secretary    (246) 536-3802</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — 536-3802; [health.gov.bb — Contact Us](https://www.health.gov.bb/Contact) — same
- **Status:** verified
- **Certainty:** 99%

---

### Claim 6 — PS Secretary telephone (line 10)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">PS Secretary    (246) 536-3806</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — lists "PS Secretary 536-3806" as a separate row from "Permanent Secretary 536-3802". Note that health.gov.bb/Contact does not include a row labelled "PS Secretary"; the alpha.gov.bb page reproduces the gov.bb directory format which carries this label.
- **Status:** verified — the label "PS Secretary" (informal shorthand for the Permanent Secretary's secretary/administrative line) and the number 536-3806 both appear verbatim on gov.bb.
- **Certainty:** 95%

---

### Claim 7 — Chief Medical Officer telephone (line 11)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Chief Medical Officer    (246) 536-3803</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health); [health.gov.bb — Contact Us](https://www.health.gov.bb/Contact)
- **Status:** verified
- **Certainty:** 99%

---

### Claim 8 — Deputy Permanent Secretary telephone (line 12)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Deputy Permanent Secretary    (246) 536-3804</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health); [health.gov.bb — Contact Us](https://www.health.gov.bb/Contact) — also lists a second "Deputy Permanent Secretary (Special Projects)" at 536-3839 (not shown on the alpha.gov.bb page)
- **Status:** verified
- **Certainty:** 99%

---

### Claim 9 — Principal Personnel Officer telephone (line 13)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Principal Personnel Officer    (246) 536-3815</pre>
</div>
...
### Claim 10 — Chief Public Health Nurse telephone (line 14)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Chief Public Health Nurse    (246) 536-3846</pre>
</div>
...
### Claim 11 — Chief Environmental Health Officer telephone (line 15)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Chief Environmental Health Officer    (246) 536-3854</pre>
</div>
...
### Claim 12 — Senior Health Promotion Officer telephone (line 16)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Senior Health Promotion Officer    (246) 536-3867</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">Senior Health Promotion Officer    (246) 536-3868

(health.gov.bb/Contact lists 536-3868; gov.bb/Ministries/health lists 536-3867.
Requires Ministry confirmation of the current correct extension.)</pre>
</div>
...
- **Open question:** Ministry to confirm whether 536-3867 or 536-3868 is the current direct line for the Senior Health Promotion Officer, and whether both route to the same desk.

---

### Claim 13 — Medical Council telephone (line 17)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Medical Council    (246) 536-3910</pre>
</div>
...
- **Type:** phone
- **Sources:** [health.gov.bb — Medical Council Contact](https://health.gov.bb/Councils/Medical-Council/Contact) — "(246) 536-3910"; [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — same number
- **Status:** verified
- **Certainty:** 99%

---

### Claim 14 — Nursing Council telephone (line 18)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Nursing Council    (246) 536-3908</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Partially verified — second number not on page</div>
<pre class="claim-block-content">health.gov.bb lists "536-3908 or 536-3912" for the Nursing Council.
The page only shows 536-3908, which is correct but incomplete.</pre>
</div>

- **Type:** phone
- **Sources:** [health.gov.bb — Nursing Council](https://www.health.gov.bb/Councils/Nursing-Council) — "536-3908 or 536-3912"; [health.gov.bb attachments — Requirements for Registration, Nursing Council (PDF)](https://www.health.gov.bb/attachments/Requirements%20for%20Registration_Nursing%20Council.pdf) — "(246) 536-3908"; [gov.bb — Ministry of Health and Wellness](https://www.gov.bb/Ministries/health) — 536-3908 only
- **Status:** verified — 536-3908 is correct. An additional number 536-3912 also exists and is not on the page, but the listed number is not wrong.
- **Certainty:** 95%
- **Note:** The page could be enhanced by adding 536-3912 as a second Nursing Council contact.

---

### Claim 15 — Ministry address (ministries.ts lines 532–537)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Frank Walcott Building, Culloden Road
St. Michael
Barbados, W.I.</pre>
</div>
...
<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">The data file should include the full Minister as the primary entry:

minister: {
  name: "Sen. The Hon. Lisa R. Cummins",
  role: "Minister of Health and Wellness and Leader of Government Business in the Senate",
}

Davidson Ishmael (Minister of State) should be retained as a secondary entry
if the data model supports it, or listed in a ministersOfState field.</pre>
</div>
...
### Claim 17 — Ministry website URL (ministries.ts line 529)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">http://www.health.gov.bb/</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Verified live — minor concern</div>
<pre class="claim-block-content">The URL resolves correctly. The site uses HTTPS in practice
(health.gov.bb redirects http to https). The data file stores the http://
variant. The URL is functional; the http:// prefix is a minor inconsistency.</pre>
</div>
...
3. **Deputy Chief Medical Officer extension omitted.** health.gov.bb/Contact lists a Deputy CMO at 536-3866 not present on the alpha.gov.bb page.
...
- [health.gov.bb — About/Mission-Vision](https://www.health.gov.bb/About/Mission-Vision)
- [health.gov.bb — Executive Management Team](https://www.health.gov.bb/About/Meet-our-Executive-Team)
