...
<pre class="claim-block-content">Under the provisions of the Motor Vehicles Act, 1988, no person can drive a motor vehicle in any public place unless he holds a valid Driving License issued to him, authorizing him to drive a vehicle of that particular category.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">Under the provisions of the Road Traffic Act, CAP 295, no person can drive a motor vehicle in any public place unless they hold a valid driving licence issued to them, authorising them to drive a vehicle of that particular category.</pre>
</div>
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">If you are at least 16 years old you may be obtaining a Learner's License for a private motor vehicle for a vehicle is 16 years (if the applicant's parents or guardians give their consent). This is not a permanent license.</pre>
</div>
...
### Claim 3 — Minimum age for permanent licence is 18 (line 15)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">If you are at least 18 years of age you may apply for a permanent license to drive a private motor vehicle.</pre>
</div>
...
### Claim 4 — Minimum age for commercial vehicle licence is 20 (line 17)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">A person who is at least 20 years old can obtain a License for driving a commercial vehicle.</pre>
</div>
...
### Claim 5 — Regulations Test fee $30 BDS (lines 31 and 56)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">A fee of $30.00 BDS
...
| Regulation Test | $30.00 |</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">Regulation Test: $30.00 BDS</pre>
</div>

- **Type:** fee
- **Status:** verified
- **Certainty:** 95%
- **Sources:** [gov.bb — Get a Driver Licence](https://www.gov.bb/Citizens/driver-licence) — fee table lists "Regulation Test: $30.00"; [BLA — Learner Permit](https://bla.gov.bb/servicedetails/TGVhcm5lciBQZXJtaXQ=) — confirms $30 regulation exam fee in prerequisites
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">| Learner's Permit | $80.00 |</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">Learner's Permit: $80.00 BDS</pre>
</div>

- **Type:** fee
- **Status:** verified
- **Certainty:** 95%
- **Sources:** [gov.bb — Get a Driver Licence](https://www.gov.bb/Citizens/driver-licence); [BLA — Learner Permit](https://bla.gov.bb/servicedetails/TGVhcm5lciBQZXJtaXQ=) — "The cost is 80.00 BBD." Both independently confirm $80.
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">| Driving Test | $100.00 |</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">Driving Test: $100.00 BDS</pre>
</div>

- **Type:** fee
- **Status:** verified
- **Certainty:** 95%
- **Sources:** [gov.bb — Get a Driver Licence](https://www.gov.bb/Citizens/driver-licence) — fee table lists "Driving Test: $100.00"
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">| Driver's License | $50.00 |</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">Driver's Licence: $50.00 BDS</pre>
</div>

- **Type:** fee
- **Status:** verified
- **Certainty:** 95%
- **Sources:** [gov.bb — Get a Driver Licence](https://www.gov.bb/Citizens/driver-licence) — fee table lists "Driver's License: $50.00"; [BLA — Driver Licence service page](https://bla.gov.bb/servicedetails/RHJpdmVyIExpY2VuY2U=) — "New Driver Licence: $50.00 BBD"
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">| International Driver's License | $65.00 |</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">International Driver's Licence (International Permit): $65.00 BDS</pre>
</div>

- **Type:** fee
- **Status:** verified
- **Certainty:** 95%
- **Sources:** [gov.bb — Get a Driver Licence](https://www.gov.bb/Citizens/driver-licence); [BLA — International Permit](https://bla.gov.bb/servicedetails/SW50ZXJuYXRpb25hbCBQZXJtaXQ=) — "Fee: $65.00 BBD". Both agree.

---

### Claim 10 — Driving Test eligibility: apply after 30 days and within 180 days of Learner's Permit (line 35)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">For obtaining a License, you must have a valid Learner's Permit and must apply after 30 days and within 180 days of issue of the Learner's Permit.</pre>
</div>
...
### Claim 11 — International Driving Licence validity = 1 year maximum (line 39)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Citizens of Barbados may drive in foreign countries with an International Driving License, which has the maximum validity of one year. Citizens are required to get their license from the country they're visiting within one year period.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">The international permit has a validity period of one year. If citizens are staying in the destination country longer, they are required to obtain a driver's licence from that country.</pre>
</div>

- **Type:** validity period
- **Status:** verified
- **Certainty:** 90%
- **Sources:** [BLA — International Permit](https://bla.gov.bb/servicedetails/SW50ZXJuYXRpb25hbCBQZXJtaXQ=) — "The international permit has a validity period of one year" and "if necessary, citizens will be required to apply for a driver licence from the country they are visiting within a one year period."
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Following documents are to be produced when applying for an International Driving Permit:
...
- Required Fees
- Two passport size photographs (To be used in Permit Book)</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">Documents required for an International Driving Permit:

- Valid driver's licence
- Proof of identity
- Valid passport (with visa where required)
- Itinerary of countries to be visited
- Two passport-size photographs (for permit book)
- Required fee ($65.00 BDS)</pre>
</div>
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Click here for the Barbados Licensing Authority website. [https://bla.gov.bb]</pre>
</div>
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Email - blasupport@barbados.gov.bb</pre>
</div>
...
<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Tel :- 1-246-536-0264 / 1-246-536-0265</pre>
</div>
...
- [Barbados Licensing Authority — Homepage](https://bla.gov.bb)
- [BLA — Learner Permit service page](https://bla.gov.bb/servicedetails/TGVhcm5lciBQZXJtaXQ=)
- [BLA — Driving Test service page](https://bla.gov.bb/servicedetails/RHJpdmluZyBUZXN0)
- [BLA — Driver Licence service page](https://bla.gov.bb/servicedetails/RHJpdmVyIExpY2VuY2U=)
- [BLA — International Permit service page](https://bla.gov.bb/servicedetails/SW50ZXJuYXRpb25hbCBQZXJtaXQ=)
