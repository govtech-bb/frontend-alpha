# Fact-check: Apply to volunteer at a sports camp
...
### Claim 1 — Volunteer eligibility age: 19 and over (line 9)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Adults and young people aged 19 and over are eligible to apply to volunteer at a sports camp.</pre>
</div>
...
### Claim 2 — Sports camps take place over the summer (line 9)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Sports camps take place over the summer</pre>
</div>
...
### Claim 3 — You can apply all year round (line 9)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">you can apply all year round</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — not publicly documented</div>
<pre class="claim-block-content">No public-web source (nsc.gov.bb, gov.bb, GIS) states that applications are accepted year-round. The 2026 NSC page says Coach Assistant Applications are "Now Open" (implying a specific window), and forms "must be returned to the Garfield Sobers Gymnasium." The Division of Youth Affairs' separate National Summer Camp has a defined registration window (late June 2025). No evidence of a permanent rolling application window.</pre>
</div>
...
### Claim 4 — Recruitment usually begins around April (line 9)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Recruitment usually begins around April.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">[Recruitment timing to be confirmed with the NSC. The NSC 2026 Coach Assistant application opened after May 2026 — not in April. The Division of Youth Affairs' separate summer camp programme opens volunteer recruitment in late June. No authoritative source places NSC sports camp volunteer recruitment in April.]</pre>
</div>
...
### Claim 5 — NSC office address: My Lords Hill, Bridgetown, St Michael (lines 17–20)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">National Sports Council office
My Lords Hill
Bridgetown
St Michael</pre>
</div>
...
<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say (current Tier 1 address)</div>
<pre class="claim-block-content">National Sports Council
The National Sports Complex
Wildey Gymnasium
Garfield Sobers Sports Complex
Wildey
St. Michael BB 22026</pre>
</div>
...
- **Note:** The NSC's 2026 camp materials reference a "Blenheim Location" for application drop-off alongside Garfield Sobers Gymnasium. If Blenheim (My Lords Hill) remains an active satellite collection point, both addresses should appear on the page. The GovBB team should confirm with the NSC before removing My Lords Hill entirely.

---

### Claim 6 — Wildey Gymnasium address and facility name (lines 22–25 and 52–55)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Wildey Gymnasium
...
<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say (official facility name)</div>
<pre class="claim-block-content">Wildey Gymnasium
...
### Claim 7 — Application form content: qualifications, sports interests, camp experience, employment, education, health (lines 29–36)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">the application form asks about your:
...
<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — application form not publicly accessible</div>
<pre class="claim-block-content">The NSC's downloadable Coach Assistant application form for 2026 is referenced on nsc.gov.bb but the PDF was not accessible for inspection via WebFetch. No public-web source enumerates these exact form fields. The listed categories (qualifications, interests, experience, employment, education, health) are plausible for a coaching assistant role but cannot be confirmed without seeing the actual form.</pre>
</div>
...
### Claim 8 — National Registration number required (lines 42–43)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Share your National Registration number.</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — form not publicly accessible</div>
<pre class="claim-block-content">Plausible — the Police Certificate of Character application also requires a National Registration number, so it is standard for government programme applications. However, the NSC application form PDF is not publicly accessible for confirmation.</pre>
</div>
...
### Claim 9 — Two references required (lines 44–45)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Give the names and contact details of 2 references.</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — form not publicly accessible</div>
<pre class="claim-block-content">Standard for safeguarding-context applications but cannot be confirmed from any public-web source. The NSC application form PDF is not publicly accessible.</pre>
</div>

- **Type:** document requirement
- **Checked:** [National Sports Council — nsc.gov.bb](https://nsc.gov.bb/) — form downloadable but PDF not fetchable; no GIS or gov.bb source enumerates NSC volunteer form fields.
- **Status:** unverifiable from public web
- **Certainty:** 55%
- **Open question:** confirm with NSC that 2 character or professional references are required on the application form.

---

### Claim 10 — Passport-sized photo for camp identification (lines 46–47)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Get a passport-sized photo for your camp identification</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — not documented in any public source</div>
<pre class="claim-block-content">Plausible (camp ID badges are common at government programmes) but not corroborated by any GIS, gov.bb, or NSC web source reviewed.</pre>
</div>

- **Type:** document requirement
- **Checked:** [National Sports Council — nsc.gov.bb](https://nsc.gov.bb/); [GIS — NSC Summer Sports Camp tag](https://gisbarbados.gov.bb/blog/tag/national-sports-council/) (HTTP 403); [GIS — Register For NSC Summer Sports Camp](https://gisbarbados.gov.bb/blog/register-for-nsc-summer-sports-camp/) (HTTP 403) — none mention photo requirement.
- **Status:** unverifiable from public web
- **Certainty:** 55%
- **Open question:** confirm with NSC whether a passport-sized photo is required as part of the application / identification process.

---

### Claim 11 — Applicants hear by mid-June (line 59)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Applicants can expect to hear if they were successful by mid-June.</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — timeline not publicly documented; inconsistent with 2025 evidence</div>
<pre class="claim-block-content">No public source (nsc.gov.bb, GIS, gov.bb) documents a mid-June notification date for NSC sports camp volunteers. The 2025 NSC camp ran July 14 – August 22, 2025, with the Division of Youth Affairs' volunteer recruitment announced 28 June 2025. If NSC recruitment follows a similar pattern, a mid-June notification is plausible but has not been confirmed, and may actually be too early given the late-June 2025 announcement pattern.</pre>
</div>

- **Type:** timeline / service standard
- **Checked:** [National Sports Council — nsc.gov.bb](https://nsc.gov.bb/) — no notification timeline stated; [Barbados Today — NSC summer camp in full flow (17 Jul 2025)](https://barbadostoday.bb/2025/07/17/nsc-summer-camp-in-full-flow/) — confirms 2025 camp timing (July 14 – August 22, 39th year) but no volunteer notification dates; [register-summer-camp fact-check](/docs/fact-check/register-summer-camp.md) Claim 12 — Division of Youth Affairs 2025 recruitment announced 28 June 2025 (not mid-June).
- **Status:** unverifiable from public web
- **Certainty:** 45%
- **Open question:** confirm with NSC the expected notification date for successful applicants. If recruitment for 2025 followed the same late-June pattern as the Division of Youth Affairs, mid-June would be too early.

---

### Claim 12 — Training must be completed in June (line 59)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">If you are offered a place as a volunteer, you need to be free to complete training in June.</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Cannot verify — training month not publicly documented; may be inconsistent with 2025 cycle</div>
<pre class="claim-block-content">No public source documents an NSC volunteer training schedule. The 2025 NSC camp began July 14, 2025, and the Division of Youth Affairs' 2025 volunteer announcement was dated June 28 — leaving very little time for a full month of June training before camps opened. Training in early July (after recruitment opens in late June) is plausible but unconfirmed.</pre>
</div>

- **Type:** timeline
- **Checked:** [National Sports Council — nsc.gov.bb](https://nsc.gov.bb/); [Barbados Today — NSC summer camp in full flow (17 Jul 2025)](https://barbadostoday.bb/2025/07/17/nsc-summer-camp-in-full-flow/) — neither documents training timing; [register-summer-camp fact-check](/docs/fact-check/register-summer-camp.md) Claim 13 — same "training in June" claim flagged as unverifiable and potentially inconsistent with the 2025 late-June recruitment cycle.
- **Status:** unverifiable from public web; may be inconsistent with 2025 cycle evidence
- **Certainty:** 45%
- **Open question:** confirm with the NSC the volunteer training schedule. If recruitment opens in late June (as the 2025 evidence suggests), "training in June" may be inaccurate — early July is more likely.

---

### Claim 13 — Police Certificate of Character link and fee (line 65)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Share a Police Certificate of Character – you can apply for one here (link: https://forms.gov.bb/CertificateOfCharacter)</pre>
</div>
...
- **"Coach Assistant" is the current NSC terminology for this volunteer role.** The NSC's 2026 application refers to "Coach Assistant" rather than "volunteer." The page uses "volunteer" throughout which is understandable plain-language, but citizens searching for the NSC form may not recognise it. Consider cross-referencing the NSC's own terminology.

- **The application form is downloadable from nsc.gov.bb — this could be noted on the page.** The NSC site states "forms will be available at the Council for persons who are unable to download it" and that completed forms go to the Garfield Sobers Gymnasium. Adding a link to nsc.gov.bb would reduce unnecessary in-person trips to collect paper forms.

- **"Sir" is dropped from the complex name throughout.** The full official name is "Sir Garfield Sobers Sports Complex" (gov.bb State Bodies). Both instances on the page (lines 23 and 53) use "Garfield Sobers Complex." The correct short form used on gov.bb is "Garfield Sobers Sports Complex."
