# Fact-check: Report elderly abuse
...
### Claim 1 — "call on 211" — police emergency number (line 25)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Go to a police station, or call on 211. You will be directed to the relevant station.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">211 is the Barbados Police emergency number. Confirmed by gov.bb, the Barbados National Numbering Plan, and multiple authoritative emergency-services sources.</pre>
</div>

- **Type:** phone
- **Sources:** [gov.bb — The Police Department](https://www.gov.bb/Departments/police-department) — lists "Emergency: (246) 211"; [Barbados National Numbering Plan (PDF)](https://telecoms.gov.bb/images/documents/NNP15.pdf) — designates 211 for Police; [US State Dept — Barbados International Travel](https://travel.state.gov/content/travel/en/international-travel/International-Travel-Country-Information-Pages/Barbados.html) — confirms Police: 211
- **Status:** verified
- **Certainty:** 99%
...
### Claim 2 — Agency name "National Assistance Board" (lines 27–34) [CRITICAL]

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Go to, call or email the National Assistance Board. You will be put in touch with a welfare officer.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">Go to, call or email the Social Empowerment Agency (SEA) — formerly the National Assistance Board. You will be put in touch with a welfare officer.</pre>
</div>
...
### Claim 3 — NAB address (lines 29–32)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Country Rd
...
<div class="claim-block claim-block--correct">
<div class="claim-block-label">Should say</div>
<pre class="claim-block-content">Murrell House
Country Road
St. Michael</pre>
</div>
...
### Claim 4 — NAB phone (246) 535-3131 (line 33) [CRITICAL]

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">(246) 535-3131</pre>
</div>
...
- **Type:** phone
- **Sources:** [gov.bb — The National Assistance Board](https://www.gov.bb/State-Bodies/national-assistance) — PBX: (246) 535-3131; [connectb1m.com — National Assistance Board](https://connectb1m.com/national-assistance-board/) — PBX: (246) 535-3131; [centenariansofbarbados.com — Services Directory](https://centenariansofbarbados.com/services-directory/) — 535-3131
- **Status:** verified — the phone number is confirmed by three independent sources as the PBX for the Murrell House/Country Road building. Post-SEA merger this number should still reach the former NAB function within the SEA. The number is correct; the agency name under which it appears (Claim 2) requires correction.
- **Certainty:** 92%
- **Citizen impact:** HIGH — life-safety number. Number confirmed correct.

---

### Claim 5 — NAB email `nab.department@barbados.gov.bb` (line 34) [CRITICAL]

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">nab.department@barbados.gov.bb</pre>
</div>
...
### Claim 6 — "You will be put in touch with a welfare officer" (line 27)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">You will be put in touch with a welfare officer.</pre>
</div>
...
### Claim 8 — "Friends and family, members of the public, caregivers or professionals can report" (lines 11–12)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Friends and family, members of the public, caregivers or professionals can report suspected abuse, neglect or mistreatment. The victim can also file a report themself.</pre>
</div>
...
### Claim 9 — "You cannot report your concern online yet" (line 23)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">You cannot report your concern online yet, so you need to either:</pre>
</div>
...
- **Type:** process step
- **Sources consulted:** [gov.bb — National Assistance Board](https://www.gov.bb/State-Bodies/national-assistance) — no online form; [socialempowermentbb.org](https://socialempowermentbb.org/) — connection refused; [gov.bb — Ministry of People Empowerment and Elder Affairs](https://www.gov.bb/Ministries/social-care) — no online reporting form described
- **Status:** unverifiable — no public source either confirms or contradicts this claim
- **Certainty:** 55%
- **Open question:** Confirm with the SEA whether an online elder-abuse reporting channel exists or is planned, and update the page accordingly when the Older Persons Act is commenced.

---

### Claim 10 — Welfare officer intake questions (lines 40–50)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">A welfare officer will ask you:
...
6. Your contact information. But you can choose to remain anonymous.</pre>
</div>

<div class="claim-block claim-block--pending">
<div class="claim-block-label">Plausible — consistent with Older Persons Bill register requirements but unverifiable in exact form</div>
<pre class="claim-block-content">The Older Persons (Care and Protection) Bill, 2026 requires the Register of Abuse to contain: name, address, telephone number of the alleged perpetrator; name and address of caregiver, relative or friend; and other information the agency deems fit. The six questions on the page are broadly consistent with this. No Tier 1 source publishes an exact interview template for the NAB/SEA intake process. The anonymous-reporting provision (item 6) is confirmed by the bill.</pre>
</div>

- **Type:** process step
- **Sources consulted:** [Barbados Today — Abusing elderly (21 Apr 2026)](https://barbadostoday.bb/2026/04/21/abusing-elderly-could-bring-100k-fine-jail-under-new-bill/) — confirms anonymous reporting and register content requirements; [CBC — Tough penalties](https://www.cbc.bb/news/local-news/tough-penalties-proposed-for-elder-abuse-under-new-legislation/)
- **Status:** unverifiable in exact form — the six-question list is plausible and partially consistent with the Older Persons Bill register requirements, but no official intake-process document is publicly available
- **Certainty:** 55%
- **Open question:** Confirm with the SEA the exact intake questions used. If the Older Persons Act is commenced, the intake process may be formalised — update the page at that point.

---

### Claim 11 — "The victim can also file a report themself" (line 12)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">The victim can also file a report themself.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified correct</div>
<pre class="claim-block-content">Consistent with the Older Persons (Care and Protection) Bill, 2026: anonymous reporting is permitted and any person aware of abuse may report. Self-reporting is not excluded anywhere in the legislation or available guidance.</pre>
</div>

- **Type:** eligibility
- **Sources:** [Barbados Today — Abusing elderly (21 Apr 2026)](https://barbadostoday.bb/2026/04/21/abusing-elderly-could-bring-100k-fine-jail-under-new-bill/); [CBC — Tough penalties](https://www.cbc.bb/news/local-news/tough-penalties-proposed-for-elder-abuse-under-new-legislation/)
- **Status:** verified
- **Certainty:** 80%

---

### Claim 12 — "assessment as soon as possible" and police/NAB co-response (lines 54–55)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">The police or the National Assistance Board will do an assessment as soon as possible and investigate whether an intervention is needed.</pre>
</div>
...
- **Sources:** [Barbados Today — SEA launched (7 Jan 2026)](https://barbadostoday.bb/2026/01/07/sea-launched-islandwide-overhaul-of-social-services-begins/); [Barbados Today — Abusing elderly (21 Apr 2026)](https://barbadostoday.bb/2026/04/21/abusing-elderly-could-bring-100k-fine-jail-under-new-bill/)
- **Status:** discrepant — "National Assistance Board" must be replaced with "Social Empowerment Agency (SEA)". The process description is otherwise consistent with available sources.
- **Certainty:** 88%
- **Confidence it's wrong:** 90% (agency name)
- **Citizen impact:** MEDIUM — the agency name error causes confusion about who the citizen is dealing with.

---

### Claim 13 — Intervention: "welfare officer and a police person may help arrange for the victim to move to a safe place" (lines 55–57)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">If it is, the welfare officer and a police person may help arrange for the victim to move to a safe place until conflict is resolved. This might mean that the elderly person stays with family or friends.</pre>
</div>

<div class="claim-block claim-block--correct">
<div class="claim-block-label">Verified (broadly) — emergency removal powers confirmed by Older Persons Bill</div>
<pre class="claim-block-content">The Older Persons (Care and Protection) Bill, 2026 grants the Social Empowerment Agency the power to remove an elderly individual from their residence in an emergency. The bill does not specify that placement must be with family or friends — other care arrangements are possible. The term "welfare officer" requires updating once the Act is commenced and SEA role titles are confirmed.</pre>
</div>

- **Type:** process step
- **Sources:** [Barbados Today — Abusing elderly (21 Apr 2026)](https://barbadostoday.bb/2026/04/21/abusing-elderly-could-bring-100k-fine-jail-under-new-bill/) — "The Social Empowerment Agency will have the power to remove an elderly individual from their residence"; [CBC — Tough penalties](https://www.cbc.bb/news/local-news/tough-penalties-proposed-for-elder-abuse-under-new-legislation/)
- **Status:** verified (emergency-removal and safe-placement powers confirmed); the "welfare officer" title requires updating (see Claim 2) but the underlying process step is consistent with authoritative sources
- **Certainty:** 75%

---

### Claim 14 — "You can choose to remain anonymous" (line 50)

<div class="claim-block claim-block--current">
<div class="claim-block-label">Currently on the page</div>
<pre class="claim-block-content">Your contact information. But you can choose to remain anonymous.</pre>
</div>
...
### B — Mandatory reporting obligation for professionals

Under the Older Persons (Care and Protection) Bill, 2026, healthcare professionals, social workers, law enforcement officers, and other specified professionals who are aware of elder abuse and fail to report it commit an offence and face a fine of $10,000. This obligation should be noted for the "professionals" category of reporters mentioned on the page — they are not merely permitted to report but legally required to.

### C — Ministry attribution

The responsible ministry for elder affairs policy is the **Ministry of People Empowerment and Elder Affairs (MPEA)**, led by Minister Adrian Forde (as of April 2026 reporting). The Murrell House/Country Road address now belongs to the SEA, which falls under MPEA. Consider adding a contact link to MPEA for policy enquiries.

Source: [gov.bb — Ministry of People Empowerment and Elder Affairs](https://www.gov.bb/Ministries/social-care)
...
- [US State Dept — Barbados International Travel](https://travel.state.gov/content/travel/en/international-travel/International-Travel-Country-Information-Pages/Barbados.html)
- [gov.bb — The National Assistance Board](https://www.gov.bb/State-Bodies/national-assistance)
- [gov.bb — Ministry of People Empowerment and Elder Affairs](https://www.gov.bb/Ministries/social-care)
- [connectb1m.com — National Assistance Board](https://connectb1m.com/national-assistance-board/)
- [centenariansofbarbados.com — Services Directory](https://centenariansofbarbados.com/services-directory/)
- [WHO — Abuse of older people (fact sheet)](https://www.who.int/news-room/fact-sheets/detail/abuse-of-older-people)
...
- [Barbados Today — Abusing elderly could bring $100K fine, jail under new bill (21 Apr 2026)](https://barbadostoday.bb/2026/04/21/abusing-elderly-could-bring-100k-fine-jail-under-new-bill/)
...
- [CBC — Tough penalties proposed for elder abuse under new legislation](https://www.cbc.bb/news/local-news/tough-penalties-proposed-for-elder-abuse-under-new-legislation/)
