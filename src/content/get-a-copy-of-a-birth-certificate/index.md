...
Most copies of birth certificates are requested at the same time a birth is registered as part of the [Register a birth service](https://alpha.gov.bb/family-birth-relationships/register-a-birth). A copy is essential for access to certain public services and welfare support. 
...
<a href="/family-birth-relationships/get-a-copy-of-a-birth-certificate/start" className='relative inline-flex items-center justify-center gap-2 rounded-sm text-body whitespace-nowrap transition-[background-color,box-shadow] duration-200 outline-none disabled-state px-6 py-4 bg-teal-dark !text-neutral-white hover:bg-brand-teal-light hover:shadow-[inset_0_0_0_4px_rgba(222,245,246,0.10)] active:bg-brand-teal-darker active:shadow-[inset_0_0_0_3px_rgba(0,0,0,0.20)] active:outline-none active:ring-4 active:ring-teal-100 active:ring-offset-1 active:rounded-sm focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-100 focus-visible:ring-offset-1 focus-visible:rounded-sm no-underline' target="_self">Request a copy now</a>

### Or get a paper Application form

 Get a paper Application birth certificate form from the Registration Department – you will need to complete it by hand and return it to the department, then you will pay when you collect it from. 
