...
describe("DateInput", () => {
  ...
  it("should call onChange with empty string when field is cleared", async () => {
  ...
  it("should sanitize non-numeric characters from day input", () => {
    ...
    expect(handleChange).toHaveBeenCalledWith("0000-00-12"); // Partial dates return empty string
  });
  ...
  it("should sanitize non-alphanumeric characters from month input but keep letters", () => {
    ...
    expect(handleChange).toHaveBeenCalledWith("0000-Jan1-00"); // Partial dates return empty string
  });
  ...
  it("should sanitize non-numeric characters from year input", () => {
    ...
    expect(handleChange).toHaveBeenCalledWith("0001-00-00"); // Partial dates return empty string
  });
  ...
  it("should be fully controlled component without internal state", async () => {
    ...
    // Parent component receives onChange call (with padding for partial date)
    expect(handleChange).toHaveBeenCalledWith("0000-00-01");

    // Parent updates with new value (padded partial date)
    rerender(
      <DateInput
        id="test-date"
        label="Date of birth"
