...
import { mentorshipApplicationStorageSchema } from "@/components/forms/mentorship-application/schema";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validationResult = mentorshipApplicationStorageSchema.safeParse(body);
    ...
    console.log("Mentorship application submitted:", {
    ...
    // - Send notification to department email
